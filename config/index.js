...
/* const FRONTEND_URL = "https://uway-front.vercel.app" || process.env.ORIGIN || "http://localhost:5173"; */
...
module.exports = (app) => {
  ...
  app.use(
    cors({
      origin: [/* FRONTEND_URL */"https://uway-front.vercel.app", "http://localhost:5173"],
    })
  );
